...
model_id = "BLACKBUN/llama-2-13b-pubmed-qa-211k"
...
args = TrainingArguments(
    # report_to="wandb",
    output_dir="llama-2-13b-imaginary-patient-cases",
    num_train_epochs=5,
...
args.output_dir = "llama-2-13b-imaginary-patient-cases"
...
merged_model.push_to_hub("llama-2-13b-imaginary-patient-cases")
tokenizer.push_to_hub("llama-2-13b-imaginary-patient-cases")