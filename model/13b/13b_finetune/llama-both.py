...
model_id = "BLACKBUN/llama-2-13b-imaginary-patient-cases"
...
args.output_dir = "llama-2-13b-both"
...
merged_model.save_pretrained("both_merged_model",safe_serialization=True)
tokenizer.save_pretrained("both_merged_model")

# push merged model to the hub
merged_model.push_to_hub("llama-2-13b-both")
tokenizer.push_to_hub("llama-2-13b-both")