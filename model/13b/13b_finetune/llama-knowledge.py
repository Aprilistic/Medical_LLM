...
args = TrainingArguments(
    # report_to="wandb",
    output_dir="llama-2-13b-knowledge",
    num_train_epochs=20,
...
args.output_dir = "llama-2-13b-knowledge"
...
merged_model.push_to_hub("llama-2-13b-knowledge")
tokenizer.push_to_hub("llama-2-13b-knowledge")