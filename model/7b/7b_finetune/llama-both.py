...
model_id = "BLACKBUN/llama-2-7b-imaginary-patient-cases"
...
args.output_dir = "llama-2-7b-both"
...
merged_model.push_to_hub("llama-2-7b-both")
tokenizer.push_to_hub("llama-2-7b-both")