...
args = TrainingArguments(
    report_to="wandb",
    output_dir="llama-2-7b-pubmed-qa-10k",
    num_train_epochs=2,
...
args.output_dir = "llama-2-7b-pubmed-qa-10k"
...
merged_model.push_to_hub("llama-2-7b-pubmed-qa-10k")
tokenizer.push_to_hub("llama-2-7b-pubmed-qa-10k")